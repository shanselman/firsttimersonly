# FirstTimersOnly
This Repository is for the "FirstTimersOnly" movement in Open Source. We want project contributors to reserve some issues for newbies.
...
We have gathered a list of resources to motivate and empower you to take that first step into becoming a contributor to the open source realm. 

If you are an OSS project owner, we have some tips for enabling you to be instrumental in ushering a new batch of programmers into the community.
